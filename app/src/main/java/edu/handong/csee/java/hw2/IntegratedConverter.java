...
/**
 * This is a class that integrates converters.
 */
public class IntegratedConverter {
    ...
    /**
     * THis is a main method that uses a constructor to use converters.
     * @param args
     */
    ...
    /**
     * This is a run method that gets fromvalue from args and executes other class, converters.
     * @param args
     */
